...
public class PlayerDataManager {
	...
	public void loadPlayerData(ProxiedPlayer p){
		if(!main.getDataPlayers().containsKey(p)){
			...
			System.out.println("Experience API : Donnees du joueur " + p.getName() + " chargees avec succés.");
		}
	}
	...
	public void savePlayerData(ProxiedPlayer p){
		if(main.getDataPlayers().containsKey(p)){
			...
			System.out.println("Experience API : Donnees du joueur " + p.getName() + " sauvegardees avec succés.");
		}
	}
